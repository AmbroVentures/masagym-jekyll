...
Neu konzentrieren wir uns vollständig auf unseren [Standort in Baden]({{ '/pages/location/baden/' | relative_url }}). Unser Standort in Wettingen ist geschlossen.

### Warum diese Entscheidung?

Um euch bessere Trainingsqualität zu bieten, setzen wir auf einen Standort. Unser Gym in [Baden]({{ '/pages/location/baden/' | relative_url }}) bietet mehr Platz, moderne Ausstattung und eine optimale Trainingsumgebung.

### Trainingszeiten in Baden

Unser [Stundenplan]({{ '/pages/courses/' | relative_url }}) wurde entsprechend angepasst:

- **Montag**: 17:00 – 18:30 Uhr
- **Mittwoch**: 20:00 – 21:30 Uhr  
- **Freitag**: 19:00 – 20:30 Uhr

Alle Trainings finden in [Baden]({{ '/pages/location/baden/' | relative_url }}) statt.
...
Alle Details zum [Standort Baden]({{ '/pages/location/baden/' | relative_url }}) und unserem [Kursangebot]({{ '/pages/courses/' | relative_url }}) findet ihr auf unserer Website.
