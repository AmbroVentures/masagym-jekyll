...
Ab August konzentrieren wir uns vollständig auf unseren [Standort in Baden]({{ '/pages/location/baden/' | relative_url }}). Dort erwartet euch modernste Ausstattung und eine optimale Trainingsumgebung.

### Neue Trainingszeiten

Unser neuer [Stundenplan]({{ '/pages/courses/' | relative_url }}) bietet euch ab dem 4. August noch mehr Flexibilität:
...
Nach der wohlverdienten Pause starten wir motiviert in die neue Saison. Unsere [Trainer]({{ '/pages/about/trainers/' | relative_url }}) freuen sich darauf, ab dem 4. August wieder mit euch an euren Zielen zu arbeiten.
...
Alle Details zu Preisen und Anmeldung findest du auf unserer [Kursseite]({{ '/pages/courses/' | relative_url }}).
