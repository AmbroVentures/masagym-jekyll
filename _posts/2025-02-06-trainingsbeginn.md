...
Nach drei erfolgreichen [Open-Trainings]({{ '/2025-01-20-eröffnungsfeier/' | relative_url }}) mit jeweils rund 20 motivierten Teilnehmern ist es endlich soweit: [Masa Gym]({{ '/pages/about/masa/' | relative_url }}) nimmt offiziell den Betrieb auf! Am Dienstag, den 25. Februar, starten wir mit unserem ersten regulären Training – und du kannst dabei sein!
...
✔ Kompetentes Training geführt von einem [Pro-Kämper]({{ '/pages/about/trainers/' | relative_url }})  
...
Das Datum passt dir nicht? Wirf einen Blick auf unseren [Stundenplan]({{ '/pages/courses/' | relative_url }}) mit unseren aktuellen Trainingszeiten und erfahre mehr über unser Angebot.
